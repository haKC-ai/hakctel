...
hakcTEL theme contributions use the separate checklist in [THEME_CONTRIBUTING.md](THEME_CONTRIBUTING.md). Firmware contributions continue to follow the Meshtastic engineering rules below.
